...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var temp$references = $as_sci_Map(references.filterNot__F1__sc_Map(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(name$1) {
        return (function(x$1$2) {
          var x$1 = $as_T2(x$1$2);
          var x = x$1.$$und1$f;
          return ((x === null) ? (name$1 === null) : $objectEquals(x, name$1))
        })
      })(name))));
      expr = temp$expr;
...
$c_Lcalculator_Polynomial$.prototype.computeSolutions__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c, delta) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$2, b$2, c$2, delta$1) {
    return (function() {
      ...
      $uD(c$2.apply__O());
      var d1 = $uD(delta$1.apply__O());
      if ((d1 < 0)) {
        return $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$()))
      } else {
        var array = [(((-b1) + $uD($g["Math"]["sqrt"](d1))) / (2 * a1)), (((-b1) - $uD($g["Math"]["sqrt"](d1))) / (2 * a1))];
